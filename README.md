...
complained earlier, and then **the same words producing a different decision**
because the incident is now known.
...
scenario, reads each service's own event log back over HTTP, and stops them. **It
